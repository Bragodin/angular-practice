...
@Component({
  ...
  template: `<app-dialog [name]='name' [sub] = 'sub' [activeUser]='activeUser' [messages]='messages'></app-dialog>`,
})
export class DialogDataComponent implements OnInit {
  ...
  constructor(private websocketService: WebsocketService, private _store: Store<IAppState>, private dialogService: DialogService) { }
